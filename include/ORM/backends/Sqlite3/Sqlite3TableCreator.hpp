...
namespace orm
{
    ...
    class Sqlite3TableCreator : public TableCreator
    {
        public:
             ...
             */
            virtual std::string autoField(const std::string& colunm_name)const;

            /**
             * \brief create a booleanField culumn
             * \param colunm_name the column name
             */
            virtual std::string booleanField(const std::string& colunm_name,bool nullable)const;
             ...
             */
            virtual std::string charField(const std::string& colunm_name,unsigned int max_length,bool nullable)const;
             ...
             * \param colunm_name the column name
             */
            virtual std::string dateField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a dateTimeField culumn
             * \param colunm_name the column name
             */
            virtual std::string dateTimeField(const std::string& colunm_name,bool nullable)const;
             ...
             */
            virtual std::string decimalField(const std::string& colunm_name,unsigned int max_digits,unsigned int decimal_places,bool nullable)const;
             ...
             * \param colunm_name the column name
             */
            virtual std::string integerField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a bigIntegerField culumn
             * \param colunm_name the column name
             */
            virtual std::string bigIntegerField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a oneToOneField culumn
             * \param colunm_name the column name
             */
            virtual std::string oneToOneField(const std::string& colunm_name,bool nullable)const;
             ...
             */
            virtual std::string fk(const::std::string& colunm_name,const std::string& table,bool nullable)const;

            /**
             * \brief create a positiveIntegerField culumn
             * \param colunm_name the column name
             */
            virtual std::string positiveIntegerField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a positiveSmallIntegerField culumn
             * \param colunm_name the column name
             */
            virtual std::string positiveSmallIntegerField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a smallIntegerField culumn
             * \param colunm_name the column name
             */
            virtual std::string smallIntegerField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a textField culumn
             * \param colunm_name the column name
             */
            virtual std::string textField(const std::string& colunm_name,bool nullable)const;

            /**
             * \brief create a timeField culumn
             * \param colunm_name the column name
             */
            virtual std::string timeField(const std::string& colunm_name,bool nullable)const;
